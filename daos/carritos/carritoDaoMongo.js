...
async function crud() {
    ...
    //await cart.getAll()
    //await cart.getById("63978a0b5f16cfcd9378ba7b")
    //await cart.deleteAll()
    //await cart.deleteById("63978a0b5f16cfcd9378ba7b")
}
